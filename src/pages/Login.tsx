    ...
    <div className="h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-background to-muted">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-budget-blue to-budget-teal-dark p-12 text-white flex-col justify-between">
        <div>
          ...
          <h2 className="mt-24 text-4xl font-bold">Welcome back</h2>
          <p className="mt-6 text-xl opacity-80">
            Log in to your account to continue managing your finances the smart way.
          </p>
        </div>
        
        <div className="rounded-lg bg-white/10 backdrop-blur-sm p-6 mt-12">
          <p className="text-lg font-medium">"Budgeta has transformed how I manage my finances!"</p>
          <div className="mt-4 flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm opacity-80">Financial Advisor</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card rounded-xl shadow-xl p-8 border">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold">Log in to Budgeta</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/forgot-password" className="text-sm text-budget-blue hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <Input 
              ...
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="remember"
                  className="rounded border-gray-300 text-budget-blue focus:ring-budget-blue"
                  checked={rememberMe}
              ...
              <div className="text-center mt-6">
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link to="/signup" className="text-budget-blue font-medium hover:underline">
                    Sign up
                  </Link>
                </p>
              </div>
